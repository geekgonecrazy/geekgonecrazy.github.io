...
- **GraphQL**: Although I see its appeal, GraphQL introduces challenges with network traffic, authorization, and increased boilerplate code necessary. I still prefer well-crafted RESTful APIs. I seriously question the argument of less api calls. Sounds like a great argument.  In reality I don't think this is true.
