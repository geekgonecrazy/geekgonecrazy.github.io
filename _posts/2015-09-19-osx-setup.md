...
![Scroll Direction](/images/2015-09-19/scroll-dir.png){: .center-image }

### Change Modifier keys
If not using an apple keyboard.

![Modifier Keys](/images/2015-09-19/modifier-keys.png){: .center-image }
...
![Dock Auto Hide](/images/2015-09-19/dock-autohide.png){: .center-image }
...
![Hot Corner](/images/2015-09-19/hot-corner.png){: .center-image }

### Finder config
Very much personal preference.

I like having the hard drive icons on my desktop.  Its convenient.
![Finder Desktop](/images/2015-09-19/finder-desktop.png){: .center-image }

Also like being able to quickly get to my home folder.
![Finder Sidebar](/images/2015-09-19/finder-sidebar.png){: .center-image }
...
![Screenshots in dock](/images/2015-09-19/Screenshots-dock.png){: .center-image }
...
![Vs Code](https://code.visualstudio.com/assets/home/home-screenshot-mac.png){: .center-image }

Open the **Command Palette** (&#8679; + &#8984; + p)) and type 'shell command' to find the **Shell Command: Install 'code' command in PATH** command.

![vscode Commands](https://code.visualstudio.com/assets/docs/setup/mac/shell-command.png){: .center-image }
...
![vscode git setting](/images/2015-09-19/git-path.png){: .center-image }
...
![ZSH Prompt](/images/2015-09-19/zsh-prompt.png){: .center-image }
